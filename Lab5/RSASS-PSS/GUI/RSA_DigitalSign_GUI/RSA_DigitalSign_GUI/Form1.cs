...
namespace RSA_DigitalSign_GUI
{
    public partial class Form1 : Form
    {
        ...
        int keysize = 3072;
        [DllImport("rsa_digital_signature.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, EntryPoint = "key_gen")]
        public static extern bool key_gen(string filePrivate, string filePublic, string format, int keysize);

        [DllImport("rsa_digital_signature.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, EntryPoint = "sign")]
        public static extern int sign(string filePrivate, string filename, string signFile);

        [DllImport("rsa_digital_signature.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, EntryPoint = "verify")]
        ...
        private void btnGenKey_Click(object sender, EventArgs e)
        {
            ...
            keysize = int.Parse(txbKeySize.Text);
            bool result_key_gen = key_gen(filePrivate, filePublic, format, keysize);
